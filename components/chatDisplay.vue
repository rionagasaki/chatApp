      ...
      <v-row class="text-center">
        <v-col cols="12">
          ...
          >
            ...
            <v-divider></v-divider>
            <bottom-input-bar @sendMessage="sendMessage" ></bottom-input-bar>
          </v-card>
        </v-col>
      </v-row>
    </v-container>
...
import BottomInputBar from '../stories/BottomInputBar.vue'
